...
<html lang="en">
<head>
<title>Add New Fitness Package</title>
...
<body>
    ...
    <div class="main">
        <div class="title">
            <h1>Add New Fitness Package</h1>
        </div>
        <form name="booking_frm" method="post">
            <table class="table tableInfo">
                <tr>
                    <th>Package Name</th>
                    <td><input type="text" class="form-control" name="fname" id="fname" placeholder=""></td>
                </tr>
                <tr>
                    <th>Description</th>
                    <td>
                        <textarea class="form-control" name="fdes" id="fdes" style="height: 150px;"></textarea>
                    </td>
                </tr>
	            <tr>
                    <th>Capacity</th>
                    <td>
                        <input type="text" class="form-control" name="fmax" id="fmax">
                    </td>
                </tr>
				<tr>
                    <th>Price</th>
				...
				<tr>
                    ...
                    <td>
                        <input type="text" class="form-control" name="fduration" id="fduration">
                    </td>
                </tr>
            </table>
           <div class="mb-3 submit d-flex justify-content-between">
		        <a href="FitnessPackage.php" class="btn btn-secondary">Back</a>
...
if (isset($_POST['submit'])) {
    ...
    if (count($errors) === 0) {
        $insertQuery = "INSERT INTO fitness_package (package_name, des, capacity, price, duration_month) VALUES ('$fname', '$fdes','$fmax', '$fprice', '$fduration')";

        if (mysqli_query($conn, $insertQuery)) {
            echo "
                <script>
                    // Show a success alert
                    alert('New Fitness Package added successfully!');
                </script>
            ";
        } else {
